    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div className='container-fluid'>
                ...
                <button className="navbar-toggler navbar-toggler-right toggle" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">
                    <FontAwesomeIcon icon={faBarsStaggered} style={{ color: "#fff" }}  />
                </button>
                <div className="collapse navbar-collapse menu" id="navbarResponsive" >
                    <ul className="navbar-nav ms-auto text-uppercase list" id="NavItem">
